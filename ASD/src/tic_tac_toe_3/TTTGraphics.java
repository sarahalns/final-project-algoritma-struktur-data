...
public class TTTGraphics extends JFrame {
    ...
    private String getPlayerName(Seed player) {
        String playerName = (player == Seed.CROSS) ? "X" : "O";
        String input;
        do {
            input = JOptionPane.showInputDialog(this, "Enter Player " + playerName + "'s name:");
        } while (input == null || input.trim().isEmpty()); // Terus meminta input jika kosong
    ...
    public TTTGraphics() {
        ...
        //meminta nama pemain x
        playerNameX = getPlayerName(Seed.CROSS);

        // Meminta nama pemain O
        playerNameO = getPlayerName(Seed.NOUGHT);
...
//        String playerName1 = (player == Seed.CROSS) ? "X" : "O";
//
//        // Display input dialog to get player's name
//        String input = JOptionPane.showInputDialog(this, "Enter Player " + playerName1 + "'s name:");
//
//        if (input != null && !input.trim().isEmpty()) {
//            playerName1 = input; // Set player's name if input is not empty
//        }
//
//        // Show message with player's name and turn
//        JOptionPane.showMessageDialog(this, "Hello, " + playerName1 + "! It's your turn.");
...
//        String playerName = (currentPlayer == Seed.CROSS) ? "X" : "O";
//        System.out.print("Player " + playerName + ", enter your name: ");
//        String playerNameInput = scanner.nextLine();
//        System.out.println("Hello, " + playerNameInput + "! It's your turn.");
//    }
    /**
    ...
    class GamePanel extends JPanel {
        ...
        public void paintComponent(Graphics g) {  // Callback via repaint()
            ...
            if (currentState == State.PLAYING) {
                ...
                statusBar.setText((currentPlayer == Seed.CROSS) ? playerNameX + "'s Turn" : playerNameO + "'s Turn");
            } else if (currentState == State.DRAW) {
                statusBar.setForeground(Color.RED);
                statusBar.setText("It's a Draw! Click to play again");
            } else if (currentState == State.CROSS_WON) {
                statusBar.setForeground(Color.RED);
                statusBar.setText(playerNameX + " Won! Click to play again");
            } else if (currentState == State.NOUGHT_WON) {
                statusBar.setForeground(Color.RED);
                statusBar.setText(playerNameO + " Won! Click to play again");
            }
        }
    }
}
